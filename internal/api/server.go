...
// It exposes build data and the build trigger over REST, and serves the embedded dashboard.
//
...
func (s *Server) TriggerBuild(w http.ResponseWriter, _ *http.Request) {
	if s.demo {
